...
class MotifFinderMEME(object):
    ...
    def find_motifs(self, params, context=None):
        ...
        """
        return self._client.run_job('MotifFinderMEME.find_motifs',
    ...
    def BuildFastaFromSequenceSet(self, params, context=None):
        ...
        """
        return self._client.run_job('MotifFinderMEME.BuildFastaFromSequenceSet',
                                    [params], self._service_ver, context)
    ...
    def ExtractPromotersFromFeatureSetandDiscoverMotifs(self, params, context=None):
        ...
        :returns: instance of type "extract_output_params" -> structure:
           parameter "report_name" of String, parameter "report_ref" of String
        """
        return self._client.run_job('MotifFinderMEME.ExtractPromotersFromFeatureSetandDiscoverMotifs',
                                    [params], self._service_ver, context)
    ...
    def DiscoverMotifsFromFasta(self, params, context=None):
        ...
        :returns: instance of type "extract_output_params" -> structure:
           parameter "report_name" of String, parameter "report_ref" of String
        """
        return self._client.run_job('MotifFinderMEME.DiscoverMotifsFromFasta',
                                    [params], self._service_ver, context)
    ...
    def DiscoverMotifsFromSequenceSet(self, params, context=None):
        ...
        :returns: instance of type "extract_output_params" -> structure:
           parameter "report_name" of String, parameter "report_ref" of String
        """
        return self._client.run_job('MotifFinderMEME.DiscoverMotifsFromSequenceSet',
                                    [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.run_job('MotifFinderMEME.status',
